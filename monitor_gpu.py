...
def monitor_gpu_memory(interval=2.0, duration=None):
                ...
                if len(measurements) >= 5:
                    ...
                    if all(recent_usage[i] < recent_usage[i+1] for i in range(4)):
                        ...
                        if recent_usage[-1] - recent_usage[0] > 200:  # Plus de 200MB
                            console.print("🚨 [bold red]MEMORY LEAK DETECTED![/] Memory increased by "
    ...
    if measurements:
        ...
        if max_usage - min_usage > 500:  # Plus de 500MB de variation
            console.print("🚨 [bold red]Large memory variation detected! Possible memory leak.[/]")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", choices=["monitor", "stress"], default="monitor",
